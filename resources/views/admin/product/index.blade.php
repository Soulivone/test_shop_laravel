    ...
    <div class="p-0">
        <table class="table text-center">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $data->id }}</td>
                    <td><img src="{{ asset('storage/' . $data->image) }}" width="75" height="50"
                            alt="{{ $data->image }}"></td>
                    <td>{{ $data->name }}</td>
                    <td>{{ $data->price }}</td>
                    <td>{{ $data->quantity }}</td>
                    <td>{{ $data->category ? $data->category->category_name: ""}}</td>
                    <td>
                        <a href="{{ route('admin.product.edit', $data->id) }}" class="me-3">
